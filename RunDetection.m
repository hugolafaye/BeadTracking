...
detectDataFile=[detectParam.detectDataFilePrefix,fileSuffixBlack,fileSuffixTrans];
...
if detectParam.boolVisualizeDetections
    ...
    %PlayVideoDetections(...
    %    fullfile(detectParam.pathResults,[detectDataFile,'.avi']),...
    %    fullfile(detectParam.pathResults,[detectDataFile,'.mat']),sp.acqFreq);
end
